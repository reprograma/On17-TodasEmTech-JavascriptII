...
//imagemLuisaSonza.style.wigth = "600px";
...
//botaoSubmit.addEvertListener('click', (evento) => {
    //evento.preventDefault();
    //const valorinput1 = input1.value;
    //const valorinput2 = input2.value;
    //const segundaDiv = document.querySelector(".segunda-div");
    //const paragrafoNovo = document.createElement('p');
    //paragrafoNovo.innerText = 'a Luiza Sonza é ${valorinput1} e ${valorinput2}';
...
//imagemLuisaSonsa.addEventListtener("mouseenter",);

function eventoImagemDiminui(){
    imagemLuisaSonsa.style.width = "40px";
};

function eventoImagemAumenta() {
    imagemLuizaSonsa.style.width = "500px";
};
